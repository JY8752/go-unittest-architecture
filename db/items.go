...
type Item struct {
	...
	Rarity string `boil:"rarity" json:"rarity" toml:"rarity" yaml:"rarity"`
...
type itemR struct {
	GachaItems GachaItemSlice `boil:"GachaItems" json:"GachaItems" toml:"GachaItems" yaml:"GachaItems"`
}
...
func (r *itemR) GetGachaItems() GachaItemSlice {
	if r == nil {
		return nil
	}
	return r.GachaItems
...
var (
	itemAllColumns            = []string{"id", "name", "rarity"}
	itemColumnsWithoutDefault = []string{"id", "name", "rarity"}
...
func (q itemQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Item, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "db: failed to execute a one query for items")
	}
...
func (q itemQuery) All(ctx context.Context, exec boil.ContextExecutor) (ItemSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "db: failed to assign all query results to Item slice")
	}
...
func (q itemQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "db: failed to count items rows")
	}
...
func (q itemQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "db: failed to check if items exists")
	}

	return count > 0, nil
}

// GachaItems retrieves all the gacha_item's GachaItems with an executor.
func (o *Item) GachaItems(mods ...qm.QueryMod) gachaItemQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`gacha_items`.`item_id`=?", o.ID),
	)

	return GachaItems(queryMods...)
}

// LoadGachaItems allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (itemL) LoadGachaItems(ctx context.Context, e boil.ContextExecutor, singular bool, maybeItem interface{}, mods queries.Applicator) error {
	var slice []*Item
	var object *Item
	...
	query := NewQuery(
		qm.From(`gacha_items`),
		qm.WhereIn(`gacha_items.item_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.GachaItems = resultSlice
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.ItemID {
				local.R.GachaItems = append(local.R.GachaItems, foreign)
				if foreign.R == nil {
					foreign.R = &gachaItemR{}
				}
...
// AddGachaItems adds the given related objects to the existing relationships
// of the item, optionally inserting them as new records.
// Appends related to o.R.GachaItems.
// Sets related.R.Item appropriately.
func (o *Item) AddGachaItems(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*GachaItem) error {
	var err error
	...
	if o.R == nil {
		...
		o.R.GachaItems = append(o.R.GachaItems, related...)
	}
...
func FindItem(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Item, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "db: unable to select from items")
	}
...
func (o *Item) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("db: no items provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to insert into items")
	}
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to populate default values for items")
	}
...
func (o *Item) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("db: unable to update items, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to update items row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: failed to get rows affected by update for items")
	}
...
func (q itemQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to update all for items")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to retrieve rows affected for items")
	}
...
func (o ItemSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to update all in item slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to retrieve rows affected all in update all item")
	}
	return rowsAff, nil
}
...
func (o *Item) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("db: no items provided for upsert")
	}
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("db: unable to upsert items, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to upsert for items")
	}
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to retrieve unique values for items")
	}
...
func (o *Item) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("db: no Item provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to delete from items")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: failed to get rows affected by delete for items")
	}
...
func (q itemQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("db: no itemQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to delete all from items")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: failed to get rows affected by deleteall for items")
	}
...
func (o ItemSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to delete all from item slice")
	}
...
func (o *ItemSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to reload all in ItemSlice")
	}
...
func ItemExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "db: unable to check if items exists")
	}

...
func (o *SchemaMigration) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to populate default values for schema_migrations")
	}
...
func (o *SchemaMigration) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to upsert for schema_migrations")
	}
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to retrieve unique values for schema_migrations")
	}
